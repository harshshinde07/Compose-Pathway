...
fun TodoItemEntryInput(onItemComplete: (TodoItem) -> Unit) {
    ...
    val submit = {
        ...
        setIcon(TodoIcon.Default) // clear the icon
...
@Composable
private fun TodoItemInput(text: String, onTextChange: (String) -> Unit, submit: () -> Unit, iconsVisible: Boolean, icon: TodoIcon, onIconChange: (TodoIcon) -> Unit, buttonSlot: @Composable() () -> Unit
) {
    Column {
        Row(Modifier
